...
exports.VALIDATOR_SYSTEM_PROMPT = exports.STATE_DECIDER_SYSTEM_PROMPT = exports.DATA_EXTRACTOR_SYSTEM_PROMPT = void 0;
exports.DATA_EXTRACTOR_SYSTEM_PROMPT = `# SUA PERSONA E OBJETIVO
...
`;
exports.STATE_DECIDER_SYSTEM_PROMPT = `LEI ZERO: SUA PERSONA E DIRETIVA PRIMÁRIA
...
\`\`\`\`;
`;
exports.VALIDATOR_SYSTEM_PROMPT = `LEI ZERO: SUA PERSONA E DIRETIVA PRIMÁRIA

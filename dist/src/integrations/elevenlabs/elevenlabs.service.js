...
let ElevenLabsService = class ElevenLabsService {
    ...
    async textToSpeech(text, voiceId, apiKey) {
        try {
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.post(`https://api.elevenlabs.io/v1/text-to-speech/${voiceId}`, {
                text,
